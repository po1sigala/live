...
* Open Compass on your local machine to do the following:
  ...
  * To work with our local MongoDB server, we first have to make a connection. By default, the local MongoDB instance runs localhost with default port 27017. We will use the default connection at `localhost:27017` to connect to Compass.  
