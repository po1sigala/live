...
bookSchema.methods.getDiscount = function() {
  let discountPrice = this.price * .5;
  console.log("The book's title is " + this.title + " and the discounted price is " + discountPrice)
};
...
const discountedBook = new Book({ title: 'Oh the Places You Will Go!', price: 100 });
