// Open this file in the browser and display the console

// Starting from the `<main id="top">` element, place a blue border around the title of the website, Develop Community Center
// Uncomment the following two lines to demonstrate the effect and the log.
// $('#top').children().css('border', 'red solid 2px');
