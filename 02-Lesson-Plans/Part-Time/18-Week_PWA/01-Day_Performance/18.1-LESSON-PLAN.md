...
* Complete activities `01-Stu_Lighthouse` through `06-Stu_Gallery-Optimize`.
...
[18.1 Time Tracker](https://docs.google.com/spreadsheets/d/1TEEspL5dXIxH8vtYovsIXGt7HajkUMYMtR9cj2Ot50Y/edit?usp=sharing)
...
* Direct students to the activity instructions located in [02-Stu_Minify-JS](../../../../01-Class-Content/18-PWA/01-Activities/02-Stu_Minify-JS/README.md)
...
* Open [loadImages.js](../../../../01-Class-Content/18-PWA/01-Activities/05-Stu_Gallery-Lazy-Load/Solved/public/assets/js/loadImages.js) and walk students through the code that enables lazy loading in our application.
