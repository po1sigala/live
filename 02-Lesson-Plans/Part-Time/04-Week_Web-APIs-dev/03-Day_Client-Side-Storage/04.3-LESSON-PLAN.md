...
* Reassure the students that mastering DOM manipulation and Web APIs is not an easy task and let them know that during today's class, there will be plenty of time for practicing and reinforcing the skills they have been learning this week. 

* Remind the students that the skills we are learning are powerful tools that allow us to build fully interactive web apps.
...
* Open the deployed [ToDo list](https://coding-boot-camp.github.io/fs-ground-04-web-APIs-todo-demo/index.html) in your browser and point out the following to students:
  ...
  * We can use text entered by a user and create a new HTML element to display it on the page.

  * We can click on a button and remove an element from the page.
