...
### 13. Instructor Demo: Mini Project (5 min) {TODO: IN NEXT SPRINT}
...
### 14. Student Do: Mini Project (60 min) {TODO Next Sprint}
...
### 15. Instructor Review: Mini Project  (10 min)  {TODO Next Sprint}
...
* Open `02-Homework/Main/index.html` in your browser and demonstrate the following:
  ...
  * In this week's homework, you will build an interactive coding app. 
