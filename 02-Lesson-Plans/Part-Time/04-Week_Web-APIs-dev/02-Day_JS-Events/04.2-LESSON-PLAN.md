...
* Explain that in today's class we are going to build on our DOM skills by learning how to use JavaScript to react to a browser or user action. 
...
* Open the [Event Target Example](https://mdn.github.io/learning-area/javascript/building-blocks/events/useful-eventtarget.html) in your browser and explain the following:
  ...
  * The MDN Web Docs team built this demo to showcase how a user action -- in this case a click -- can trigger a JavaScript reaction.
...
* Note that we have already learned most of the skills needed to achieve this functionality. 
...
* Explain that in today's class, we will focus on learning how to add event listener. 
