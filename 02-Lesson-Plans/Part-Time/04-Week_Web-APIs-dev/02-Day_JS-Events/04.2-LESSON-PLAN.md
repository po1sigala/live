...
* Open `19-Stu_Local-Storage/index.html` in your browser and demonstrate the following:

  * 🔑 We click on the buttons to increase and decrease the number of hours coded. 

  * 🔑 When we refresh the page, the number of hours does not reset. It stays the same. 

* Open Chrome DevTools and click the Application tab to open the Application panel. Scroll down to the local storage. 
