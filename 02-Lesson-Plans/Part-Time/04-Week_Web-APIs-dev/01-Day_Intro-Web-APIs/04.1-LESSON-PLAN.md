...
* Be prepared to switch between your browser, IDE, and console when demonstrating these activities. It is important for students to see the relationship between manipulating the DOM and what is displayed in the browser.
...
* Open `03-Ins_Traverse-DOM/index.html` in your IDE to demonstrate the following:
  ...
  * 🔑 DOM traversal allows us to access the DOM using parent-child relationships. 
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ How can we set the style of an element inline using the DOM? 
