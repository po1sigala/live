...
* `Summary: Complete activities 1-6 in Unit 22`
...
[22.1 Time Tracker](https://docs.google.com/spreadsheets/d/1Qm57-Qog5yLsRSi7_9u-DhN3dkbNZiqQDv9f7ga9KcE/edit?usp=sharing)
...
* Go through the [22.1: MERN](https://docs.google.com/presentation/d/1pTDZ37jFNFVHDa6v9qxRHr_CtKVWj0WOJ2O5p_ZlDEY/edit?usp=sharing) slide deck.
...
* Open [01-Ins_Mern](../../../../01-Class-Content/22-MERN/01-Activities/01-Ins_Mern) in your editor and cd into it.
...
* Introduce [02-Stu_Recipes](../../../../01-Class-Content/22-MERN/01-Activities/02-Stu_Recipes)
...
* Open [02-Stu_Recipes/Solved](../../../../01-Class-Content/22-MERN/01-Activities/02-Stu_Recipes/Solved) in your IDE.
...
* Open the [client/src/App.js](../../../../01-Class-Content/22-MERN/01-Activities/02-Stu_Recipes/Solved/client/src/App.js) file and go over the new code:
...
* Now open [client/src/components/RecipeList/index.js](../../../../01-Class-Content/22-MERN/01-Activities/02-Stu_Recipes/Solved/client/src/components/RecipeList/index.js) in your IDE and point out the following:
...
* Introduce students to [03-Stu_AJAXBooks](../../../../01-Class-Content/22-MERN/01-Activities/03-Stu_AJAXBooks)
...
* Open and run the [03-Stu_AJAXBooks/Solved](../../../../01-Class-Content/22-MERN/01-Activities/03-Stu_AJAXBooks/Solved) to the previous activity and demonstrate the result in your browser:
...
* Open the `Books` component [client/src/pages/Books.js](../../../../01-Class-Content/22-MERN/01-Activities/03-Stu_AJAXBooks/Solved/client/src/pages/Books.js) in your IDE.
...
* Introduce students to [04-Stu_AJAXFormDelete](../../../../01-Class-Content/22-MERN/01-Activities/04-Stu_AJAXFormDelete)
...
* Open up the [04-Stu_AJAXFormDelete/Solved](../../../../01-Class-Content/22-MERN/01-Activities/04-Stu_AJAXFormDelete/Solved) to the previous activity and go over the new code as a class. The only changes that needed to be made are in the `client/src/pages/Books.js` file.
...
* Introduce [05-Stu_ReactRouter](../../../../01-Class-Content/22-MERN/01-Activities/05-Stu_ReactRouter)
...
* Once time's up, go over the [05-Stu_ReactRouter/Solved](../../../../01-Class-Content/22-MERN/01-Activities/05-Stu_ReactRouter/Solved) version of the last activity.

* Open the [client/src/App.js](../../../../01-Class-Content/22-MERN/01-Activities/05-Stu_ReactRouter/Solved/client/src/App.js) file in your IDE go over the new code:
...
* In this final activity, students are tasked with deploying the React Reading List app to Heroku. They can use the [05-Stu_ReactRouter/Solved](../../../../01-Class-Content/22-MERN/01-Activities/05-Stu_ReactRouter/Solved) version of the previous activity.

* **Instructions:** [06-Stu_Deployment/README.md](../../../../01-Class-Content/22-MERN/01-Activities/06-Stu_Deployment/README.md)
...
* Spend a few minutes introducing the [requirements for final projects](https://docs.google.com/presentation/d/1ulUf1lCaj4sH1K7ym8sZL1IOuvHDeiwbe_NAOBqhwE8/edit?usp=sharing).
