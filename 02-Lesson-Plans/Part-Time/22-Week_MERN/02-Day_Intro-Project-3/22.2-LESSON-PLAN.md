# 22.2 Lesson Plan - Project 3 Intro (6:30 PM)

## Overview

In this class, we will be reviewing databases and React in preparation for the final projects. You will also introduce the final project's requirements and help the students get started.

## Instructor Notes

* Congratulate the students for the progress they have made so far!
...
* Explain using databases and React
...
[22.2 Time Tracker](https://docs.google.com/spreadsheets/d/1nMYaCRVlwwzrXGESZLnLo5gI9ZmjGF8BUMpLcUeSCC0/edit?usp=sharing)
