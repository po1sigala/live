# 21.3 Lesson Plan - State Management with the Store (10:00 AM)
...
* `Summary: Complete activities 16-22 in Unit 21`.
...
[State Management with the Store](https://docs.google.com/spreadsheets/d/16RHVhdmdnOk4kN6hwZB2RYv59eFYlXAPOkL-3lJVUrU/edit?usp=sharing)
...
* Run [16-Ins_useReducer](../../../../01-Class-Content/21-State/01-Activities/16-Ins_useReducer/) by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
* Open [App.js](../../../../01-Class-Content/21-State/01-Activities/16-Ins_useReducer/src/App.js) in your IDE and explain the following points:
...
* Introduce [useReducer/Unsolved](../../../../01-Class-Content/21-State/01-Activities/16-Stu_useReducer/Unsolved)
...
* Open [App.js solved](../../../../01-Class-Content/21-State/01-Activities/16-Stu_useReducer/Solved/src/App.js) and explain the following:
...
* Run [useReducer/Solved](../../../../01-Class-Content/21-State/01-Activities/18-Ins_useRef/Solved) by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
* Open [App.js solved](../../../../01-Class-Content/21-State/01-Activities/18-Ins_useRef/Solved) in your IDE and explain the following:
...
* Run [useReducer/Solved](../../../../01-Class-Content/21-State/01-Activities/19-Stu_useRef/Solved) by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
* Open [App.js Solved](../../../../01-Class-Content/21-State/01-Activities/19-Stu_useRef/Solved/src/App.js) in your IDE and explain the following points:
...
* Run [Ins_Store](../../../../01-Class-Content/21-State/01-Activities/20-Ins_Store) by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
* Open [Ins_Store](../../../../01-Class-Content/21-State/01-Activities/20-Ins_Store/src/App.js) in your IDE and explain the following points:
...
* Open [Ins_Store](../../../../01-Class-Content/21-State/01-Activities/20-Ins_Store/src/utils/GlobalState.js) in your IDE and explain the following points:
...
Introduce students to [Store unsolved](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Unsolved).
...
* Run [Store Solved](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Solved) by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:
...
* Open [GlobalState.js](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Solved/src/utils/GlobalState.js) in your IDE and point out the following:
...
* Open [Form.js](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Solved/src/components/Form.js) in your IDE and point out the following:
...
* Open [TodoList.js](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Solved/src/components/TodoList.js) in your IDE and explain the following:
...
* Return to the tab with the [GlobalState.js](../../../../01-Class-Content/21-State/01-Activities/22-Stu_Mini_Project/Solved/) directory open and run `npm install` followed by `npm start`.
...
* Introduce students to the [Mini-Project](../../../../01-Class-Content/21-State/01-Activities/22-Stu_Mini_Project/Unsolved/)
...
* Start by opening [actions.js](../../../../01-Class-Content/21-State/01-Activities/21-Stu_Store/Solved/client/src/utils/actions.js) in your IDE.
...
* Open [createPostForm.js](../../../../01-Class-Content/21-State/01-Activities/22-Stu_Mini_Project/Solved/client/src/components/createPostForm.js) in your IDE and explain the following:
...
* Open [PostsList.js](../../../../01-Class-Content/21-State/01-Activities/22-Stu_Mini_Project/Solved/client/src/components/PostsList.js) and explain the following:
...
* Open [Detail](../../../../01-Class-Content/21-State/01-Activities/22-Stu_Mini_Project/Solved/client/src/pages/Detail) and explain the following: 
