# 21.2 Lesson Plan - The React Context API (6:30 PM)
...
* `Summary: Complete activities 8-14 in Unit 21`.
...
[The React Context API](https://docs.google.com/spreadsheets/d/1QVLTdDyyuveerGo8dKvVW2d_jRviGpTYUdhRl8Ok5jU/edit?usp=sharing)
...
- Introduce [08-Stu_PropDrilling/Unsolved](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Unsolved)
...
* Run `npm start` in [08-Stu_PropDrilling/Solved](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Solved) and demonstrate the functioning application in your browser.

* Open [Gallery.js](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Solved/src/pages/Gallery.js)  in your IDE. Point out the following key aspects of the activity:
...
* Then open [Components/Card](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Solved/src/components/CardContainer/index.js) and point out the following:
...
* Next, open [Components/Card](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Solved/src/components/Card/index.js) and point out the following:
...
* Next, open [Components/Card](../../../../01-Class-Content/21-State/01-Activities/08-Stu_PropDrilling/Solved/src/components/CardBtn/index.js) and point out the following:
...
* Run [useContext Demo](../../../../01-Class-Content/21-State/01-Activities/09-Ins_useContext/)   by copying the `src` folder into your prepared CRA application. Navigate to http://localhost:3000/ in your browser and demonstrate the following:

  * The application still works the same as the previous iteration, but this time utilizes global state.

* Open [DeveloperContext.js](../../../../01-Class-Content/21-State/01-Activities/09-Ins_useContext/src/utils/DeveloperContext.js) in your IDE and explain the following:
...
* Open [Developer.js](../../../../01-Class-Content/21-State/01-Activities/09-Ins_useContext/src/components/Developer.js) in your IDE and explain the following:  
...
* Open [App.js](../../../../01-Class-Content/21-State/01-Activities/09-Ins_useContext/src/App.js)
...
* Introduce students to [useContext unsolved](../../../../01-Class-Content/21-State/01-Activities/10-Stu_useContext/Unsolved)
...
* Open up [useContext Solved Search page](../../../../01-Class-Content/21-State/01-Activities/10-Stu_useContext/Solved/src/pages/Search/index.js) in your IDE.
...
* Open up [SearchResults component](../../../../01-Class-Content/21-State/01-Activities/10-Stu_useContext/Solved/src/components/SearchResults/index.js).
...
* Run [DynamicContext Demo](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/) in your browser to demonstrate the application. Click each button and show that the alert changes for each button.

* Open [AlertContext.js Solved](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/src/AlertContext.js) in your IDE and point out the following:
...
* Open [App.js Solved](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/src/App.js) and point out the following:
...
* Open [Home.js Solved](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/src/pages/Home.js) in your IDE and point out that there are no references to props.
...
* Open [Content.js Solved](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/src/components/Content.js) and point out the following:
...
* Open [Alert.js Solved](../../../../01-Class-Content/21-State/01-Activities/11-Ins_DynamicContext/src/components/Alert.js) and point out that it accepts props as we expect it to.
...
* Open [Dynamic Context solved](../../../../01-Class-Content/21-State/01-Activities/12-Stu_DynamicContext/Solved) in your IDE and point out the following:
...
* Open [UserContext.js Solved](../../../../01-Class-Content/21-State/01-Activities/12-Stu_DynamicContext/src/utils/UserContext.js) in your IDE and point out the following:
...
- Files: [14-Stu_MultipleContexts](../../../../01-Class-Content/21-State/01-Activities/14-Stu_MultipleContexts)
...
* Open [14-Stu_MultipleContexts/Solved/src/utils/userContext.js](../../../../01-Class-Content/21-State/01-Activities/14-Stu_MultipleContexts/Solved/src/utils/userContext.js) in your IDE and go over the following:
  ...
  * Open [14-Stu_MultipleContexts/Solved/src/pages/Gallery.js)](../../../../01-Class-Content/21-State/01-Activities/14-Stu_MultipleContexts/Solved/src/pages/Gallery.js) in your IDE.
...
* There is also an extra `15-Bonus_ClassContext` example activity for students who are curious about using the Context API in regular class components.
