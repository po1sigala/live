...
* Students may need some time to remember how to use a testing environment. Interpreting the test descriptions and error messages are key parts in solving some of the activities. Re-engagement takes time, but is a great way to make TDD concepts stick in their memory.
