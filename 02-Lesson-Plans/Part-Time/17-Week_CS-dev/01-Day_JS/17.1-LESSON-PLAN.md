...
* Open `04-Stu_Functional-Execution-Context/Solved/index.js` in your IDE and explain the following: 
  ...
  * 🔑 The variables,  `total` and `i`, declared in the inner function, `sum()`, are undefined in the outer function, `arg()`. They are private variables.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ What happens to the functional execution context of a function once it has finished executing?
...
* Open `05-Ins_Stacks/__tests__/index.test.js` in your IDE to demonstrate the following:
  ...
  * The test descriptions give you clues on how to implement a stack, a data structure type:
    
    * How to initialize the constructor.

    * What the names and functions are of both methods. 
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ Does anyone know why this data structure method is called last in first out or LIFO?

  * 🙋 The latest item to be added to a stack is also first one to be removed. 

  * ☝️ Why are we learning this?

  * 🙋 Data structures store data and are fundamental components in computer science. Data structures commonly appear on technical interview questions.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ How comfortable do you feel with a `stack`? (Poll via Fist to Five, Slack, or Zoom)
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ Can anyone name a use case for a stack?

  * 🙋 Reverse a string, check for symmetry, check for equality.
