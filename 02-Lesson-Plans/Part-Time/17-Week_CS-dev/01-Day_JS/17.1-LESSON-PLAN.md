...
* You will be using `jest` to test some of the activities. Be sure to familiarize yourself with the tests, and note to students, they should not be changed or modified.

* The first activity, `01-Ins_Global-Execution-Context`, steps through the execution process of JavaScript in the browser.
