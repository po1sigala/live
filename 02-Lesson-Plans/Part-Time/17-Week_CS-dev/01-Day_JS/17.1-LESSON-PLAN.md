...
* Navigate to `05-Ins_Stacks` in the terminal and execute the following command:
  ...
  * The response in the console reveals all four tests are passing.  Remember not change any of the tests.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ Why is a stacks's operations are considered last in first out or LIFO?
