...
* Open <http://localhost:3001/> in your browser to demonstrate the following:
  ...
  * 🔑 Now let's try logging in by navigating to <http://localhost:3001/> and attempting to view some images shortly after.

  * Notice that after logging in, we have only a few seconds before the website asks us to log in again. This is a result of the expired session.
