## 20.1 Lesson Plan - Intro to React, Components and JSX (6:30 PM)
...
* `Summary: Complete activities 1-9 in Unit 20`
...
[20.1 Time Tracker](https://docs.google.com/spreadsheets/d/1-_qMnhKQ_3WzPR1DMBxjJFCxp2o6fUat6fT3EOP5fRM/edit?usp=sharing)

- - -

### 1. Instructor Do: Go Through Slides (15 mins)

* Go through the [20.1: Intro to React, Components, and JSX](https://docs.google.com/presentation/d/1M35LtiiJlAmDK27cjyifhbhvcTAoYaUF7-9s6k6ZIP8/edit?usp=sharing) slide deck.
...
* Have students work with partners and introduce them to [14-Stu_DocumentationQuestions](../../../../01-Class-Content/20-React/01-Activities/01-Stu_DocumentationQuestions/README.md).
...
* Slack out the [Solved](../../../../01-Class-Content/20-React/01-Activities/01-Stu_DocumentationQuestions/Solved/README.md) version of the activity and call on various students to answer a few of the questions out loud.
...
* Introduce students to [HelloReact](../../../../01-Class-Content/20-React/01-Activities/02-Stu_HelloReact/README.md)

### 6. Instructor Do: Review Hello World Example (10 mins)

* Open the [Solved](../../../../01-Class-Content/20-React/01-Activities/15-Stu_HelloReact/Solved/README.md) version of the activity in your IDE and go over the answers with the class. Use the solution as a guide to walk the class through the code.
...
* **Instructions:** [README](../../../../01-Class-Content/20-React/01-Activities/03-Stu_HelloDiv/README.md)

### 8. Instructor Do: Review HelloDiv (5 mins)

* Once time is up, go over the [Solved](../../../../01-Class-Content/20-React/01-Activities/03-Stu_HelloDiv/Solved) version of the activity as a class.
...
* Replace your React application's src folder with [06-Ins_HelloBootstrap/src](../../../../01-Class-Content/20-React/01-Activities/06-Ins_HelloBootstrap/src) and start the development server by running `npm start`. See the rendered application at [localhost:3000](http://localhost:3000).
...
* **Instructions:** [README](../../../../01-Class-Content/20-React/01-Activities/05-Stu_HelloBootstrap/README.md)

### 12. Instructor Do: Review Hello Bootstrap (8 mins)

* Briefly go over the [Basic Solved](../../../../01-Class-Content/20-React/01-Activities/05-Stu_HelloBootstrap/Solved/Basic) version of the previous activity.
...
* Take a few moments to demonstrate the [Bonus Solution](../../../../01-Class-Content/20-React/01-Activities/05-Stu_HelloBootstrap/Solved/Bonus). The rendered page should be the same, so you only need to walk demonstrate the code in your editor.
...
* Replace your React app's `src` folder with [19-Ins_JSXVariables/src](../../../../01-Class-Content/20-React/01-Activities/06-Ins_JSXVariables/src). Stop the dev server if it is already running. Start the app in dev mode by running `npm start`.
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/07-Stu_JSXVariables/README.md)

### 15. Instructor Do: Review JSX Variables (5 mins)

* Go over the [Solved](../../../../01-Class-Content/20-React/01-Activities/07-Stu_JSXVariables/Solved) version of the activity.
...
* Replace your React app's `src` folder with [08-Ins_CSSDemo/src](../../../../01-Class-Content/20-React/01-Activities/08-Ins_CSSDemo/src). Stop the dev server if it is already running. Start the app in dev mode by running `npm start`.
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/09-Stu_StyleProp/README.md)

* Slack out `22-Stu_StyleProp/Unsolved`

### 18. END (0 mins)

* If any time remains go over the [solution](../../../../01-Class-Content/20-React/01-Activities/09-Stu_StyleProp/Solved) to the previous activity.
