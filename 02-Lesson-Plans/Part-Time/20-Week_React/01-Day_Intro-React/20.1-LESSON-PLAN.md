...
* In this lesson, students will complete activities `01-Ins_Create-React-App` through `10-Stu-Props`.
...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `08-Stu_Component/README.md`.

### 13. Student Do: Props (15 min)

* Direct students to the activity instructions found in `08-Stu_Component/README.md`.
...
### 14. Instructor Review: Prop (10 min)
...
* Be sure to first copy the contents of `08-Stu_Component/Solved/Basic/src` to `00-practice-app` before explaining the following:
...
### 17. Instructor Review: Map (15 min)
