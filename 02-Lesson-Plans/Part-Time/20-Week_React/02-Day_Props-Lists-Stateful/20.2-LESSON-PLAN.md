# 20.2 Lesson Plan - Props, Lists, and Stateful Components (6:30 PM)
...
* `Summary: Complete activities 10-16 in Unit 20`
...
[20.2 Time Tracker](https://docs.google.com/spreadsheets/d/1vu1WtgOBHKy0DOiPTHawdljoQmv4pnhuU8BXnfHKkhM/edit?usp=sharing)

---

### 1. Instructor Do: Go through Slides (10 mins) (High)

* Go through the [20.2: Props, Lists, and Stateful Components](https://docs.google.com/presentation/d/18Q6g_4tMD01MyMUw8euaoldLHdJgJodbbd5XSzXV8UQ/edit?usp=sharing) slide deck.
...
* Replace your React app's `src` folder with [10-Ins_PropsDemo/src](../../../../01-Class-Content/20-React/01-Activities/10-Ins_PropsDemo/src). Stop the dev server if it is already running. Start the app in dev mode by running `npm start`.
...
* **Instructions:** [README](../../../../01-Class-Content/20-React/01-Activities/11-Stu_PropsCalculator/README.md)

### 4. Instructor Do: Review Calculator Props (10 mins) (High)

* Open [PropsCalculator solved](../../../../01-Class-Content/20-React/01-Activities/11-Stu_PropsCalculator/Solved) in your IDE.
...
* Introduce students to [Props review](../../../../01-Class-Content/20-React/01-Activities/12-Stu_PropsReview/)
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/12-Stu_PropsReview/README.md)
...
* Slack out the [solution](../../../../01-Class-Content/20-React/01-Activities/12-Stu_PropsReview/Solved) to the previous activity. Go through the code as a class.
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/13-Stu_ComponentMap)
...
* Slack out the [solutions](../../../../01-Class-Content/20-React/01-Activities/13-Stu_ComponentMap/Solved) to the previous activity and go over the code as a class.
...
* Replace your Create React App's `src` folder with [14-Ins_BasicState](../../../../01-Class-Content/20-React/01-Activities/14-Ins_BasicState/src). Stop the dev server if it is already running. Start the app in dev mode by running `npm start`.
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/15-Stu_DecrementCounter/README.md)

### 11. Instructor Do: Review Decrement Counter (10 mins) (High)

* Slack out the [solved](../../../../01-Class-Content/20-React/01-Activities/15-Stu_DecrementCounter/Solved) versions of the previous activity and go over both solutions.
...
* **Instructions:** [README.md](../../../../01-Class-Content/20-React/01-Activities/16-Stu_FriendRefactor/README.md)

### 14. Instructor Do: Review Friend Refactor (15 mins)

* Go over the [solution](../../../../01-Class-Content/20-React/01-Activities/16-Stu_FriendRefactor/Solved) to the previous activity.
...
* Slack out the [solved](../../../../01-Class-Content/20-React/01-Activities/18-Stu_FunWithForms/Solved) version of the previous activity. If any time remains go through the code as a class.
