# 20.3 Lesson Plan - Forms, Conditional Rendering & React Router (10:00 AM)

`Summary: Complete activities 17-23 in Unit 20`
...
[20.3 Time Tracker](https://docs.google.com/spreadsheets/d/1agZoqXM_xk9RjwW2W2Zcgep8L-i6s9zseHok_Q6ULeM/edit?usp=sharing)
...
* Swap out your application's `src` folder with [src](../../../../01-Class-Content/20-React/01-Activities/17-Ins_FormsDemo/src). Stop the dev server if it is already running. Start the app in dev mode by running `npm start`.
...
* **Instructions:** [README](../../../../01-Class-Content/20-React/01-Activities/18-Stu_FunWithForms/README.md)

### 3. Instructor Do: Review Fun With Forms (10 mins)

* Open [Solved/components/Form/index.js](../../../../01-Class-Content/20-React/01-Activities/18-Stu_FunWithForms/Solved/components/Form/index.js) in your browser and demonstrate the application:
...
* Open [Solved/components/Form/index.js](../../../../01-Class-Content/20-React/01-Activities/18-Stu_FunWithForms/Solved/components/Form/index.js) in your IDE and point out the following:
