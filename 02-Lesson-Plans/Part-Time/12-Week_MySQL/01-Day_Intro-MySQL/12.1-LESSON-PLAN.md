...
[Unit 12-MySQL Day 1 Time Tracker](https://docs.google.com/spreadsheets/d/1kbuR6lOo2ee1LDlKOgXStOr43EfRs16GbzAP-_vaOxk/edit?usp=sharing)
...
* Highlight the above code and then hit the lightning-bolt symbol on MySQL Workbench to run it. Reload your connection to the server and, using the navigator, point out how there is now a table called "people" in our database.
