...
* You will assume the role of 'scrummaster' and hold standup meetings with each group. The purpose of these scrums is to: 
...
* Keep the standup meetings short. Ask each student the following questions:
...
* Also let them know that you will be checking on each group to hold standup meetings with them to gauge their progress.
...
* Hold standup meetings with each group. Ask each student in the group the following questions:
