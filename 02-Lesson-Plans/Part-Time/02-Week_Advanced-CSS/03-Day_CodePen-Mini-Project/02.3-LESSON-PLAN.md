...
* Open [Wireframe example from Wikipedia](https://en.wikipedia.org/wiki/Website_wireframe#/media/File:Profilewireframe.png) in your browser and explain the following:
  ...
  * Let students know it is important to pay particular attention to the location of navigation bars, titles, headers, content, images, footers, etc.

* Ask the class the following questions (☝️) and call on students for the answers (🙋):

  * ☝️ Do wireframes require styling?

  * 🙋 No, they are early blueprints for the website that is being built.

### 2. Instructor Demo: Wireframing (5 min) 

* Open `21-Ins_Wireframing/README.md` in your browser and demonstrate the following slide:
...
* Open `28-Stu_Mini-Project/Main/index.htm` in your browser and demonstrate the following:
...
* Open `22-Stu_Wireframing/Solved/README.md` in your browser and explain the following slide: 
