...
* Open [Wireframe example from Wikipedia](https://en.wikipedia.org/wiki/Website_wireframe#/media/File:Profilewireframe.png) in your browser and explain the following:
  ...
  * Wireframes are a way for us to visualize how our web pages will act and feel without doing any actual coding.

  * Explain that wireframes can be hand sketched or you can use tools like Figma or Framebox which allow you to create wireframes on your PC.

  * Let students know it is important to pay particular attention to the location of navigation bars, titles, headers, content, images, buttons, and footers.

  * Explain that there are three elements to a well created wireframe: Information design, navigation design, and interface design.
    
    * Information Design - How we place and present information to our users.

    * Navigation Design - How the user moves throughout the site and the how pages relate to each other.

    * Interface design - How the user interacts with the elements on the page with a focus on functionality.

  * Let students know that they will get hands-on experience by creating a wireframe for this units mini-project.

### 2. Instructor Demo: Wireframing (5 min) 

* Open `21-Ins_Wireframing/assets/Images/01-unfinished-wireframe.png` in your IDE and demonstrate the following image:

  * This is the start of a wireframe for the unit mini-project but with our rows and columns highlighted.
...
* Open `28-Stu_Mini-Project/Main/index.html` in your browser and demonstrate the following:
  ...
  * Here is the final product we will be creating today, keep this in mind when you begin wireframing.

  * 🔑 Pay attention to how elements are placed in relation to each other and try to convey that in the wireframe you end up creating.
