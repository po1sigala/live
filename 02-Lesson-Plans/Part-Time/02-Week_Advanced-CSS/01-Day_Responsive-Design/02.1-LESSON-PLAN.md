...
* The activities of this unit use `max-width` over `min-width` for media query breakpoints. This is because it's a bit simpler to introduce responsive breakpoints with a desktop-first approach. 
