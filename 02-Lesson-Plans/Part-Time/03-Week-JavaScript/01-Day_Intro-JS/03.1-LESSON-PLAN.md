...
* Open the [slide deck](https://docs.google.com/presentation/d/125APA1-Q3Tu6Sjevvriy2BQy7y7LCrEqxUlovWNGBt0/edit?usp=sharing) and follow these prompts on their corresponding slides:
  ...
  * **JavaScript** 
    ...
    * This unit is all about introducing ourselves to using JavaScript to apply logic and make our applications feel more dynamic.
  ...
  * **Can we achieve these types of interactions using only HTML and CSS?**
    ...
    * While there are some great features built into HTML and CSS that give users a sense of interaction or functionality on a site, they are unable to handle the complex tasks that occur in response to these interactions. 

    * Because of this, web developers utilize another programming language specifically designed for these tasks.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We are learning how to add interactivity and logic to our applications with JavaScript

  * ☝️ How does this project build off or extend previously learned material?

  * 🙋 We've learned HTML and CSS to create and present content, now we're going to make it interactive and dynamic.

  * ☝️ How does this project relate to your career goals?

  * 🙋 JavaScript is used to power most modern web applications and is crucial for us to know and use as web developers. This project will help us learn how to use JavaScript to apply logic, rules, and interactivity to our applications without having the added distraction of HTML and CSS, which we already know a bit.
