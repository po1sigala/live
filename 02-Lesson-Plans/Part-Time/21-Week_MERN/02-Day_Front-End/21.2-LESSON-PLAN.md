...
* Open `http://localhost:3001/graphql` to demonstrate the following:
  ...
  * An API is the part of the server that responds to data requests and sends responses. When we open the Sandbox (Apollo Studio Explorer), we can visualize how a GraphQL API performs these tasks.
