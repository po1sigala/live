...
* Students will be expected to have Node.js installed, but if they don't, be sure to tell them that they can install it using the resources found on the [Node.js download page](https://nodejs.org/en/download/).
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 We are deepening our knowledge of Node, third party modules as well as Node's native `fs` module

    * ☝️ How does this project build off or extend previously learned material?

    * 🙋 We are continuing to build on our knowledge of using Javascript to build programs, but this time outside the browser

    * ☝️ How does this project relate to your career goals?

    * 🙋 Part of being a full stack web developer is being as comfortable working on backend technologies as you are with front end technologies. Here we are adding another tool to our arsenal which will ultimately make us better developers.
...
* Use the prompts and talking points (🔑) below to review the following key points:
  ...
  * ✔️ Arrow functions are simply shorter syntax compared to their functional expression counterparts.

  * ✔️ Arrow functions do not bind to the keyword `list`, so they can't be used with constructors.

  * ✔️ They can be shortened even further when doing an implicit return statement. Example: `() => console.log("Hello")`
...
* Use the prompts and talking points (🔑) below to review the following key points:
  ...
  * ✔️ This exercise was to help you solidify how to use and recognize newer ES6 syntax.

  * If you still feel unsure about using these keywords, it is okay to use whatever you feel most comfortable with.
