...
* Students will be expected to have Node.js installed, but if they don't, be sure to tell them that they can install it using the resources found on the [Node Installation Blog](TODO).
