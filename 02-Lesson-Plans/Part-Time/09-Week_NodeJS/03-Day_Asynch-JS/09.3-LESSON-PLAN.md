...
* Open [26-Stu-ObjDestructuring] in your IDE and explain the following: 
...
* @TODO Open [Git docs](https://git-scm.com/book/en/v2/GitHub-Contributing-to-a-Project) in your browser and explain the following:
