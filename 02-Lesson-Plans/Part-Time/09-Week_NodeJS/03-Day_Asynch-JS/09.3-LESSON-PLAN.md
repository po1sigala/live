...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 This will help us learn how to use Node's `fs` module and also an added benefit of keeping readme files looking fresh. Employers often view your pinned projects on GitHub and a nice readme can be the difference between them appreciating the technologies you used, or them moving on to the next candidate.
