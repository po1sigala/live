...
* Navigate to `27-Stu_Timer-App/Solved/index.html` in your browser and demonstrate the following:
  ...
  * While the app may look daunting right now, this app builds on the web fundamentals we already know: HTML, CSS, and JavaScript. In addition, much of the complex functionality is actually handled by Web APIs, allowing us to create all the functionality we just saw in a few lines of code. 

* Ask the class the following questions (☝️) and call on students for the answers (🙋):

  * ☝️ What are we learning?

  * 🙋 We are learning to use Web APIs to create and manipulate HTML elements and add complex functionality to our projects with just a few lines of code. 
