...
* Open `03-Ins_Traverse-DOM/index.html` in your IDE to demonstrate the following:
  ...
  * 🔑 We can also access an element inside a body directly by targeting the id of the element using the method `.getElementbyId()`.
  ...
  * 🔑 We can set and change an element's style settings inline by accessing an element's style object and its properties. 
