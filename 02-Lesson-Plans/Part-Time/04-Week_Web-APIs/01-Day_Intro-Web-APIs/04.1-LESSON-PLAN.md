...
This class introduces the Document Object Model. Students will gain experience using Web APIs to get elements, set attributes, create elements, append elements and work with timers.

## Instructor Notes

* In this lesson, students will complete activities `XX-Ins_Demo-Title` through `XX-Stu_Activity-Title`.

* This unit introduces real-world use cases for the programming concepts students learned in JavaScript and sets students up for success when transitioning to front-end frameworks such as React. 

* JavaScript is what ties together HTML and CSS and brings the user experience to life. Let students know that the work they are doing with JavaScript now will pay off heavily as the course proceeds. {TODO: Make this cleaner}
...
* By the end of class students will be able to:
  ...
  * Implement timers and intervals using {TODO}
...
* Open the [Unit 4 Slide Deck](https://docs.google.com/presentation/d/1D3DGPpajoRdzTxMterML_jQqcIy_yhoCrUSdpJhYE5Q/edit?usp=sharing) and follow these prompts on their corresponding slides:
  ...
  *  In this unit, we will learn how to {TODO} 
