...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `02-Stu_Window-Object`.

### 3. Student Do: Window Object (15 min) 

* Direct students to the activity instructions found in `02-Stu_Window-Object`.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We use the document method `.getElementbyId()` to quickly access an element directly. 
...
How might you use parent-child relationships to access the elements you want to style?  
