...
This class introduces the Document Object Model. Students will gain experience using Web APIs to create, get and append elements as well as set attributes. Students will also work with timers. 


 get elements, set attributes, create elements, append elements and work with timers.
...
* Open the [Unit 4 Slide Deck](https://docs.google.com/presentation/d/1D3DGPpajoRdzTxMterML_jQqcIy_yhoCrUSdpJhYE5Q/edit?usp=sharing) and follow these prompts on their corresponding slides:
  ...
  * In this unit, we are going to take the next step in building interactive web pages by learning how to using the power of the DOM to access, create, and change HTML elements using JavaScript.
