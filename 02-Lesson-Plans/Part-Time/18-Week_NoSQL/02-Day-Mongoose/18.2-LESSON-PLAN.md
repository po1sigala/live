# 18.2 Lesson Plan - Intro To Mongoose (6:30 PM)
...
* Complete activities `9-15` in `18-NoSQL`
...
[17.2: Intro To Mongoose Time Tracker](https://docs.google.com/spreadsheets/d/1Tn92cwaBKeecj6MW22olYnc9j-PJZxZCpuKfRBzL1_U/edit?usp=sharing)
...
* Start class with a quick review by opening up [09-Stu-Mongojs-Review/Solved/server.js](../../../../01-Class-Content/18-NoSQL/01-Activities/09-Stu-Mongojs-Review/Solved/server.js) on your machine. Run `npm install` then `node server.js` to launch the application.
