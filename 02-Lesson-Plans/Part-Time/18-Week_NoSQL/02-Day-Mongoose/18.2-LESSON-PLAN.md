...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 Not at all! It is important to remember that Mongoose is simply a tool for convenience, especially compared to ORMs like Sequelize which were more essential for relational databases. MongoDB has plenty of built-in features for helping us organize, analyze, and keep track of our data on its own. However, Mongoose will help us handle the data more easily.
