...
* Navigate to `08-Ins_Cursor-Methods` in your command line and run `npm install` and `node server` to demonstrate the following in Insomnia:
...
* Open `08-Ins_Cursor-Methods/server.js` in your IDE and explain the following: 
...
* Direct students to the activity instructions found in `10-Stu_Cursor-Methods/README.md`.
...
* Navigate to `10-Stu_Cursor-Methods/Solved` in your command line and run `npm install` and `node server` to demonstrate the following in Insomnia:
