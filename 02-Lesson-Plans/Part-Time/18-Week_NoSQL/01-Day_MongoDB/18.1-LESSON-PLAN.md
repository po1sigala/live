...
* Be sure to have MongoDB and Compass installed on your machine before class. Refer to the [MongoDB installation guide on The Full-Stack Blog](https://coding-boot-camp.github.io/full-stack/mongodb/how-to-install-mongodb).
...
* Navigate to `28-Stu_Mini-Project/Main` in your command line and run `npm install` demonstrate the following:
  ...
  * In the console, we can see all the data that has been populated and added to our database. We can query this data using a `GET` request.
