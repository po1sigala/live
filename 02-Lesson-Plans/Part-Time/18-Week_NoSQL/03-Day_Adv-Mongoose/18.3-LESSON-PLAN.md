...
* Run `npm seed && npm start` from the command line and demonstrate the following:
  ...
  * First let's review the folder structure of this application:
    ...
    * To keep things organized, we broke up our code into multiple files. In our server file you can see that we import our database connection and our routes:
