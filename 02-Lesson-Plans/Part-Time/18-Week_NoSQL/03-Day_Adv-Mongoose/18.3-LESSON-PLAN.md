...
* Make a POST request to `https://localhost:3001/api/users` with the following JSON and demonstrate the following:
...
* Make a POST request to `https://localhost:3001/api/posts` with the following JSON and demonstrate the following:
