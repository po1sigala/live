...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Mongoose documentation on Virtuals](https://mongoosejs.com/docs/tutorials/virtuals.html), and stay for Office Hours to ask for help.
