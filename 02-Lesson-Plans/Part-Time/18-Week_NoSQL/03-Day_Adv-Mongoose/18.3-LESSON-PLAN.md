...
* Open `https://student-stats-db.herokuapp.com/api/students` in your browser and demonstrate the following:
  ...
  * This is an API that contains Courses, Students and assignments.
  ...
  * The focus of this mini project will be taking a mostly complete API and adding the ability to calculate the overall grade of a student. The other part will be learning how to deploy the application to Heroku and how to use the MongoDB Atlas service.
