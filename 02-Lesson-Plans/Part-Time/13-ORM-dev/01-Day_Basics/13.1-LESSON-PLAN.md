...
* Open `07-Ins_Update-Delete/routes/api/bookRoutes` in your IDE and demonstrate the following: 
  ...
  * 🔑 * Make a GET request to `http://localhost:5001/api/books/9780201896831` to see the following response:
  ...
  * 🔑 We use the `WHERE` clause inside the object to find the book that needs to be deleted based on the request parameters.
