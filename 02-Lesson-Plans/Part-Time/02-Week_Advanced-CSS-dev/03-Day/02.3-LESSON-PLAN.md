...
* This day is about exposing students to what's possible with CSS. They've learned a lot of foundational knowledge that's required in the field, but CSS can also be a lot of fun once you get the hang of it.
...
* Students may become overwhelmed by how many tools and solutions CSS has to offer, so offer support and reiterate often that CSS gets easier through practice and a lot of trial and error. This is what platforms like CodePen is for!
...
### 7. Instructor Review: { ACTIVITY NAME } (10 mins)  
...
### 10. Instructor Review: { ACTIVITY NAME } (10 mins)  
