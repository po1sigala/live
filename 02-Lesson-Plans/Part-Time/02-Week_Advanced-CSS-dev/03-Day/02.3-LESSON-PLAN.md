...
* Select HTML elements in different ways using CSS selectors.

* Utilize CSS variables and explain their use.

* Apply advanced CSS styling for an enhanced UI.
...
* Open [CodePen](https://codepen.io) in your browser and explain the following:
  ...
  * CodePen and communities like (Glitch, Dribble, etc.) it have become a great resource for developers to learn how to do new things with their code and showcase work they've done that may not be a full web application.
...
* Open `21-Ins_Media-Query-Print/index.html` in your browser and demonstrate the following:

  * 🔑 When we go to print the page, it looks different and more readable!
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material and stick around for Office Hours to ask for help, but CSS is best learned through a lot of repeated practice.
