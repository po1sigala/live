# 02.3 Part-Time Lesson Plan: Advanced CSS

## Overview 

This lesson is all about exposing students to what's possible with CSS for both the end user and the developer writing it. Whereas the previous two lessons were primarily focused on essential CSS knowledge, this lesson will introduce some other tools and skills that will increase the students' efficacy in building webpages.

## Instructor Notes

* In this lesson, students will complete activities `21-Ins_Media-Query-Print` through `28-Stu_Mini-Project`
...
* To emphasize that CSS can be fun and interesting, the class will begin with a quick introduction to CodePen. Before class, take a few minutes to acclimate yourself to it and perhaps find a few cool examples of work displayed on there.
...
### 2. Instructor Demo: Print Media Queries (5 min) 
...
* Open `21-Ins_Media-Query-Print/index.html` in your browser, then open the print preview using `File > Print` and demonstrate the following:
  ...
  * 🔑 We can achieve this with a different type of media query.

* Open `21-Ins_Media-Query-Print/assets/css/style.css` in your IDE and demonstrate the following:

  * 🔑 Using the `@media print` media query, we can adjust how our page looks when printing content, like in the following example:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We usually don't need to see every part of a webpage when it's printed. It also saves ink!
...
### 3. Student Do: Print Media Queries (15 min) 
...
### 4. Instructor Review: Print Media Queries (10 min)  
...
* Open `22-Stu_Media-Query-Print/Solved/assets/css/style.css` in your IDE and explain the following: 
  ...
  * 🔑 To make links more readable, we can use pseudo-elements to actually print the content of the `href`. Draw attention to the following code:
...
* Open `26-Stu_CSS-Variables/Solved/assets/css/style.css` in your IDE and explain the following: 
  ...
  * 🔑 Repeating values throughout a style sheet can be error prone, so we store them under a named variable, like in the following example:
  ...
  * 🔑 This is great for colors because hex codes are hard to remember, but you can also use it with other values such as border radius.
...
* Break your students into groups that will work together on this activity.
  ...
  In this activity, you will work with a group to build a webpage that will hold a collection of CSS snippets. What better way to learn CSS than to build a knowledgebase of CSS?
  ...
  * Must incorporate a background color using a CSS gradient function. For more information, see (https://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient)

  * Must incorporate a bit of animation using the [CSS transition property](https://developer.mozilla.org/en-US/docs/Web/CSS/transition).

  * You and your group can decide what CSS styles and colors you use to design the application, but the app needs to be a responsive. Use the following images to gain an understanding of how it should look at different screen sizes from a layout perspective:
...
* Open `28-Stu_Mini-Project/Solved` in your IDE and explain the following: 
  ...
  * 🔑 We build a mobile-first style sheet where our media queries apply to larger screens, not smaller, as shown in the following example:
  ...
  * 🔑 We can create a gradient effect for our backgrounds using the `linear-gradient()` function, like in the following example:
  ...
  * 🔑 We can animate HTML elements on a pseudo-class state using the `transition` property, as follows:
