...
This lesson is all about exposing students to what's possible with CSS for both the end user and the developer writing it. Whereas the previous two lessons focused primarily on essential CSS knowledge, this lesson will introduce some other tools and skills that will increase the students' efficacy in building webpages.
...
* Reassure students that learning and mastering CSS is not an easy task and that even the world's best developers struggle with it at times. It requires a lot of patience and practice, but it is worth it when you see something come together.
...
* Open `21-Ins_Media-Query-Print/index.html` in your browser, then open the print preview using `File > Print` and demonstrate the following:
  ...
  * 🔑 After we click on `print`, we can see that the print preview looks different and more readable!
...
* Open `21-Ins_Media-Query-Print/assets/css/style.css` in your IDE and demonstrate the following:
  ...
  * 🔑 Using the `@media print` media query, we can adjust how the page looks when printing content, like in the following example:
...
* Use the prompts and talking points (🔑) below to review the following key points:
  ...
  * ✔️ Hiding anything that's unnecessary for printing
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [MDN Web Docs on using media queries](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries), and stick around for office hours to ask for help.
...
* Break your students into groups that will work together on this activity.
  ...
  * Must incorporate a background color using a CSS gradient function. For more information, see the [MDN Web Docs on theCSS linear-gradient function](https://developer.mozilla.org/en-US/docs/Web/CSS/linear-gradient).
