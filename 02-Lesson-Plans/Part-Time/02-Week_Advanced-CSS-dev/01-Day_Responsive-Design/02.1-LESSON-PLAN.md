...
* Open the [slide deck](https://docs.google.com/presentation/d/1ZQE4ze6uHbYu-M-oQ3UBfqTkCGfhHU6ZhLDL8rN-3fg/edit?usp=sharing) and follow these prompts on their corresponding slides:
  ...
  * **How can we learn to build these features?**: CSS is a unique language as it gives the developer many options for how to accomplish a goal. 
...
* Open `28-Stu_Mini-Project/Solved/index.html` in your browser and open Chrome DevTools to demonstrate simulating a mobile viewport.
  ...
  * 🔑 It is a webpage to hold a collection of CSS snippets that we learned throughout this unit. It's like a CSS cheatsheet!
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
    ...
    * 🙋 Learning more advanced CSS with nice layouts creates webpages that stand out. @TODO EXPAND ON THIS
