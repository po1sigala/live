...
* Generate a report with all the categories checked, and explain the following:
  ...
  *  Follow the link in the Time To Interactive metric to [Learn more](https://developer.mozilla.org/en-US/docs/Glossary/Time_to_interactive) to obtain more details on the metric and the corrective measures to improve this metric.
