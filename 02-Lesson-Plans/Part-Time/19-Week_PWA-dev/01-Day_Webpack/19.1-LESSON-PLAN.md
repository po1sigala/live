...
* Set up weback’s dependencies in an application with npm scripts.
...
* Open `06-Stu_Webpack/Solved/webpack.config.js` in your IDE and explain the following: 

  * The error message in the terminal is shown below:

  ![The error message in the terminal offers clues as to where the bug is located](./Images/bundle-error.png)
