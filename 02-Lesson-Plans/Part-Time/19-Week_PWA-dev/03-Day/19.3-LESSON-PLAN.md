...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ What are some benefits of native application?
...
* Open `21-Ins_IndexedDB/assets/js/database.js` in your IDE and explain the following:
  ...
  * 🔑 We have to install the `idb` package and import it into the `database.js` file, as shown below:
...
* Open `28-Stu_Mini-Project/Main/client/.npmrc` in your IDE and explain the following:
  ...
  * 🔑 This tells Heroku to not purge our dev dependencies when we deploy to Heroku. We need a webpack for our application to work properly which is a dev dependency.
