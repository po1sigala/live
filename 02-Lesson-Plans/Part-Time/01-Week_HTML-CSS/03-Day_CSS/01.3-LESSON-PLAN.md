...
* Open `22-Stu_Mini-Project/Main/index.html` in your browser and demonstrate the following:
  ...
  * Select the pointer icon and then point at an element on the page. A box should indicate the element's accessibility including the role as read by an accessibility device. If applicable, a contrast score will also be indicated.
...
* Break your students into groups that will work together on this activity.
  ...
  * It's done when the page is deployed to GitHub Pages.
  ...
  5. Navigate to <your-github-username>.github.io/<your-repository-name> and you will find that your new webpage has gone live! (If your GitHub username is "lernantino" and the project is "css-demo-site", then your URL would be "lernantino.github.io/css-demo-site".)
