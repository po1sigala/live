...
* Navigate to [GitHub.com](https://github.com) in your browser and demonstrate the following:
  ...
  * Now that we've created a project board we can add projects to it by navigating to any project repository and selecting the `Projects` tab. From here click the `Add project` button and select the project board from the dropdown. The project board will now appear in the `Quick Access` box below!
