...
* Determine project groups prior to class. Assign 3 students per group: one advanced, one average, one struggling.  **DO NOT allow students to work alone or in pairs.** Group projects are one of the few opportunities for students to work collaboratively. 
