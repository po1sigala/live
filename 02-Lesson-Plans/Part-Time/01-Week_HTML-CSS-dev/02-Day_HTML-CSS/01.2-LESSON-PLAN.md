...
* Open `09-Ins-CSS-Color/assets/style.css` in your browser and demonstrate the following:
  ...
  * 🔑 We can also hexadecimal colors as specified by `#RRGGBB.` This allows us to be more specific in our color choice.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We use CSS properties to define the colors we want applied to our elements.
