...
*  Learning HTML and CSS can be overwhelming, especially to learners who may have little prior coding experience. Remind students that they should feel free to Google syntax as needed to reinforce our classroom learning.
...
* Open `07-Ins_Attributes/index.html` in your IDE and demonstrate the following:
  ...
  * We use a `<link>` element to connect our CSS to our HTML and add global attributes to identify elements for styling.  We will be learning more about how to style HTML elements on our own in upcoming activities.
