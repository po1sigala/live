...
* Stress that for each project in this course, you will be required to write a `README` that describes why you built the project, what problem does it solves, and what you learned in developing a solution.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 A `README` file is used by developers to convey information. For each activity, a `README` file provides the information needed to complete our task. Project `README` files explains why the project was built, the problem solved and what was learned in the process.
