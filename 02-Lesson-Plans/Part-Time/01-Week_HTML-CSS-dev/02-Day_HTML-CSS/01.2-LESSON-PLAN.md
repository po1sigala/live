...
* During the last class, students were introduced to `user stories` and `acceptance criteria`. These tools will be used throughout the course to define user goals and identify the conditions that must be met for the solution to be accepted. To help reinforce 
