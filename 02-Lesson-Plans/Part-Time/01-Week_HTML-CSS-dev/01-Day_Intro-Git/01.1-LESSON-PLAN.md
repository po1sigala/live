...
* Perform a `git pull` to download the day's activities from the class repository prior to each class.
...
* The instructional team should actively engage with each group and make sure any issues are addressed. If unable to troubleshoot an individual's concerns during the time allotted, refer them to Office Hours.
...
* Open [GitHub](https://github.com/) in your browser and demonstrate the following. 
  ...
  * 🔑 We select Public because all of the repositories we create in this course will need to be public in order to deploy to GitHub Pages and be able to get support from TAs regarding Homework.
...
* Open your terminal and demonstrate the following:
  ...
  * 🔑 Let's add an HTML file in our local repository using the `touch` command.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We create the repository in GitHub and download it to our local machine using `git clone`.
