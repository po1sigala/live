...
* This class introduces students to the class repository and the use of `git pull`. Remind students to do a `git pull` of the class repo to have each day's activities ready and open in VS Code. 
...
* Be familiar with classroom expectations and processes and know how to seek out help. 
