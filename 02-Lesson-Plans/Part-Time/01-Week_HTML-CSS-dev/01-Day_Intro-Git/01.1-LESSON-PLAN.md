...
| 9:00PM | 9   | Instructor Demo:                    | 0:05     |
| 9:05PM | 10  | Student Do:                         | 0:15     |
| 9:20PM | 11  | Instructor Review:                  | 0:10     |
| 9:30PM | 12  | END                                 | 0:00     |
...
* Otherwise, inform the students that if they need help installing any of the tools discussed, they can reach out to a TA or stay for Office Hours. Proceed directly to `BREAK (15 min)`. 

* Answer any questions before proceeding to the next activity.

### 3. Student Do: Set-Up and Installation Check (20 min) 

* During this time, the students will break out into small groups to troubleshoot any installation issues and make sure they have VSCode, Slack, and GitHub up and running on their machines.
...
* Open `02-Stu_Command-Line/README.md` in your IDE and explain the following: 
  ...
  * 🔑 We use the `acceptance criteria` to identify when the user's goal has been met. To meet the goal, we need to create new directory named `first-day`. Inside that directory, we need to create an `index.html` file. 
...
### 10. Instructor Review: Git (15 min)
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ What steps do we take to create a repository using Github?

  * 🙋 We create the repo in GitHub and download it to our local machine using `git clone`.

   * ☝️ What steps do we take to push changes to our remote repo?
