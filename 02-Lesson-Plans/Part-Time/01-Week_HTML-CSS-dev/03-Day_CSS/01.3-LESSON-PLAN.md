...
Today's lesson will delve further into CSS and introduces the box model and layout using the display and position properties. Students will also work together to complete a landing page mini-project that reinforces HTML and CSS fundamentals.
...
* Set how an element is positioned in an HTML document using the CSS position property.
