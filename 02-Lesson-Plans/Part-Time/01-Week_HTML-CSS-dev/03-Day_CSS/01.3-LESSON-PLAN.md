...
* Open your command line and demonstrate the following:
  ...
  * 🔑 To initialize version control in a project, we use `git init`. It is important that we are in our project folder when we run this command!
...
* Open [GitHub](https://github.com/) in your browser and demonstrate the following:
  ...
  * 🔑 Do not click on any of the checkboxes since we are importing an existing repository!
