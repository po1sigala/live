...
* Open `20-Stu_CSS-Positioning/Solved/assets/css/style.css` in your IDE and explain the following: 
  ...
  * To use absolute positioning to position the second box, we first need to set the parent element to relative.
...
* Open `20-Stu_CSS-Positioning/Solved/index.html` in your browser and explain the following: 
  ...
  * When we open the webpage, we see the acceptance criteria has been met. 
...
* Open `22-Stu_Mini-Project/Main/index.html` in your IDE and explain the following: 
  ...
  * 🔑 We use a `<figure>` element to add an image and a caption. We use an `alt` attribute to describe our image so it is accessible.
...
* Open `22-Stu_Mini-Project/Main/assets/css/style.css` in your IDE and explain the following: 
  ...
  * 🔑 We use an element selector to select all the list items and set the display property to `inline-block`. This will give us a horizontal set of links in the navbar.
