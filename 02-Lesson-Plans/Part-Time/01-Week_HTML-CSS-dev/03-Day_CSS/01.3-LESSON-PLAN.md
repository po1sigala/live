# 01.3 Part-Time Lesson Plan: HTML, CSS, and Git
...
* Be prepared to demonstrate creating a Git repository using both `git clone` and `git init`. If needed, please review [Git Basics - Getting a Git Repository](https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository) prior to class, so you feel prepared to handle any student questions as they arise. o the `Everyone Do: Git` activity together in class with the students following along.
...
* Open `18-Stu_CSS-box-model/Solved/assets/css/style.css` in your IDE and explain the following: 
  ...
  * To meet the acceptance criteria, we must center all four image inside the box evenly. 
...
* Students already went over creating a new GitHub repo on Day 1, but this is a more thorough git activity!
