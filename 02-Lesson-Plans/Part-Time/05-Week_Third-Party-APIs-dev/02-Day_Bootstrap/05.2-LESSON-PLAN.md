...
|---     |---  |---                                         |---       |
| 6:30PM | 1   | Instructor Do: CSS Frameworks              | 0:10     |
...
* Open `14-Stu_Bootstrap-Layout/Solved/index.html` in your IDE and explain the following: 
    ...
    * Walk through this portion of the solution HTML to explain the column sizing and grid alignment with `align-items-end`:
