...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ The documentation shows us exactly how each component can be used along with sample code.

    * ✔️ Since we don't know everything about it yet, it's easiest to copy and paste their sample code into your HTML and edit it to your needs.

    * ✔️ Some of the components, such as the dismissible Alert, rely on three JavaScript files Bootstrap provides in the "Get Started" section. 
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ Any element with a class of `col-*` needs to be a direct child element of an element with a class of `row`. This is the Flexbox parent/child relationship at work.

    * ✔️ Bootstrap uses a "mobile-first" responsive system, meaning `col-` is going to adhere to the smallest screen and up, then `col-sm`, `col-md`, etc., classes will help control the width of a column on different screen sizes. 

    * ✔️ We can have as many different Bootstrap layouts as we need on a page, including rows nested inside of existing columns to create a new 12-column grid.
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ The use of utility classes makes it so we don't have to make custom one-off classes for small tasks like spacing, positioning, or sizing.

    * ✔️ The resulting HTML has more classes listed, but each class serves a single purpose and can be reused for other HTML elements. 

    * ✔️ Proper sizing, spacing, and positioning can really make a big difference in how a page looks.
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ All it takes is adding another class to the HTML element you want to style and then a CSS rule for it in your stylesheet.

    * ✔️ A lot of developers use Bootstrap for layout, sizing, and spacing, leaving only the fun things like color and typography to be done by hand using CSS.

    * ✔️ If it's a lot of style that need to be overridden, you may want to not use that Bootstrap class in the first place and see what it does using DevTools.
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ Google Fonts will then provide you the `<link>` tag needed for your app and the `font-family` CSS declaration needed to get started.  

    * ✔️ We don't want to pick too many fonts or variations of a font either, as loading them will take a longer time and slow down our site.
