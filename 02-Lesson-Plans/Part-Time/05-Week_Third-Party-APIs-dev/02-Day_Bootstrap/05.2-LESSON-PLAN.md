...
* Explain that all of this is built using CSS properties that we already know; Bootstrap has simply done a lot of the work for us. All we have to do is learn how to apply their prebuilt CSS classes, and we can use their styles!
...
![The solution shows a handful of Bootstrap components on top of one another to form a webpage.](./Images/01-solved-screenshot.png)
...
* Use [Google](https://www.google.com) or another search engine to research the preceding question.
```
...
![The solution shows that the form is centered on the page with a dark background.](./Images/01-solved-screenshot.png)
