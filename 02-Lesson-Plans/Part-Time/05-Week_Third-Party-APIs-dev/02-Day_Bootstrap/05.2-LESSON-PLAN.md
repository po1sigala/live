...
* Take a few minutes before class to get familiar with both the [Bootstrap documentation](https://getbootstrap.com/docs/4.5/getting-started/introduction/) and [Google Fonts documentation](https://developers.google.com/fonts/), as students will rely heavily on these resources in class and might need a nudge in finding answers.
...
* Open `12-Stu_Bootstrap-Components/Solved/index.html` in your IDE and explain the following: 
  ...
  * 🔑 Each component works by using classes that are defined in the Bootstrap stylesheet. Scroll down to the Card HTML, as follows:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Bootstrap documentation](https://getbootstrap.com/docs/4.5/getting-started/introduction/), and stick around for office hours to ask for help.
...
* Open `14-Stu_Bootstrap-Layout/Solved/index.html` in your IDE and explain the following: 
  ...
  * 🔑 Walk through this portion of the solution HTML to explain the column sizing at different breakpoints and the grid alignment with `align-items-end`, as follows:
...
* Open `16-Stu_Bootstrap-Utilities/Solved/index.html` in your IDE and explain the following: 
  ...
  * 🔑 We can center a page's content vertically and horizontally by making the page have a minimum height set to the height of the page and making it a Flexbox, as follows:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Bootstrap documentation on utilities](https://getbootstrap.com/docs/4.5/utilities/borders/), and stick around for office hours to ask for help.
...
* Open `18-Stu_Bootstrap-Extend/Solved/assets/js/script.js` in your IDE and explain the following: 
  ...
  * 🔑 We were able to add custom classes to both existing HTML and any HTML created as a result of the form being submitted, as follows:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, check DevTools to determine what styles are needed, and stick around for office hours to ask for help. 
...
* Open `20-Stu_Google-Fonts/Solved/index.html` in your IDE and explain the following: 
  ...
  * 🔑 We need to ensure that the Google Font `<link>` comes before our own custom stylesheet so that the fonts are loaded before we put them to use, as follows:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Google Fonts documentation](https://developers.google.com/fonts/), and stick around for office hours to ask for help. Like all things CSS, it's just about putting it to practice. There are also a few links included in the activity's readme to help with picking the right font.
