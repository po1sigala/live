...
* Be ready to assist students with the `Everyone Do: Git Revert` activity in case students get stuck.
...
* Open the `git_revert_demo` directory in your IDE and copy the [27-Ins_Git_Revert/script.js](../../../../01-Class-Content/05-Third-Party-APIs-dev/01-Activities/27-Ins_Git_Revert/script.js) file into it.

  * We are taking the `script.js` file from our previous activity. First, we will make our initial commit.
