...
* Congratulate the class on learning how to implement new web technologies like webpack and workbox. These tools can give our application a performance boost and improve the user experience.
