...
* Break your students into pairs that will work together on this activity.
  ...
  * It is done when I have specified the `swSrc` property in the `InjectManifest` constructor in the `plugins` array in `webpack.config.js`.
