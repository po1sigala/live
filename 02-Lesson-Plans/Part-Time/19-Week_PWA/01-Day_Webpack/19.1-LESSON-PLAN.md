...
* Open `04-Stu_Webpack-Intro/Solved/index.html` in your IDE and explain the following:
  ...
  * For now, we will manually copy the `index.html` to the `dist` folder after the build. But we need to make one change. The script change must be updated to the output filename, or `main.js`. 
