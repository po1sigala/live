...
* Open [25-Ins_Multiple-Classes/restaurant.js](../../../../01-Class-Content/10-OOP/01-Activities/25-Ins_Multiple-Classes/restaurant.js) in your IDE and explain the following:
...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `26-Stu-Multiple-Classes/README.md`.

### 9. Student Do: Implement Multiple Classes (15 min) 

* Direct students to the activity instructions found in `26-Stu-Multiple-Classes/README.md`.
...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `27-Evr-Git-Stash-Pop/README.md`.
