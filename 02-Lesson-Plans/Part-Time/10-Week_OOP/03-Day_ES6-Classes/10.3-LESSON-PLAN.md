...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `27-TODO`.
  <!-- TODO: Add actual folder name here -->

### 11. Everyone Do: Git Stash, Pop and Reset (20 min)

* @TODO Open [Git docs](https://www.git-scm.com/docs/git-stash) in your browser and explain the following:
