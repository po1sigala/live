...
* Open `07-Ins-Promises` in your IDE and explain the following:
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * ☝️ How can we write asynchronous functions in a cleaner way?

  * 🙋 We can use promises instead of callbacks.
