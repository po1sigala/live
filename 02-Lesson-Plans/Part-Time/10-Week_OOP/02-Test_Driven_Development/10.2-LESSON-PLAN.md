...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `12-Stu-TDD/README.md`.

### 3. Student Do: Test Driven Development (15 min)

* Direct students to the activity instructions found in `12-Stu-TDD/README.md`.
...
* Open `12-Stu-TDD/Solved/test/algo.test.js` in your IDE and explain the following: 
...
* Open `14-Stu_Pass-Tests/Solved/test/algo.test.js` in your IDE and explain the following: 
  ...
  * 🔑  Lets repeat the TDD cycle with the second test. `isPalindrome` includes two tests that we need to pass. The first verifies that it `"should return true if a string is a palindrome"` and the second verifies that it `"should return false if a string is not a palindrome"`.
...
* Open `14-Stu_Pass-Tests/Solved/test/algo.test.js` in your IDE and explain the following: 
  ...
  * 🔑  Lets repeat the TDD cycle one last time with the third and final test. `capitalize` includes one test that we need to pass, verifying that it `"should take a string and return a new string with the first letter of each word capitalized"`.
...
* Open `10-Ins_Organizing-Tests/test/todo.test.js` in your IDE and demonstrate the following:
...
* Open `10-Ins_Organizing-Tests/test/todoList.test.js` in your IDE and explain the following:
  ...
  * 🔑  This file contains a **negative test**. We run these tests to check things work in edge cases or cases where the function should return a negative result. 
...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `16-Stu-organizing-Tests/README.md`.

### 9. Student Do: Implement and Write organizing Tests (15 min)

* Direct students to the activity instructions found in `16-Stu-organizing-Tests/README.md`.
...
### 11. Instructor Review: Implement and Write organizing Tests (10 min) 
...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `20-Stu-Mock-Fs/README.md`.

### 16. Student Do: Mock and Spy on `fs` Module (15 min)

* Direct students to the activity instructions found in `20-Stu-Mock-Fs/README.md`.
