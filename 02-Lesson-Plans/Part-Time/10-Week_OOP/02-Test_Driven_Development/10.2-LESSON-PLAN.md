...
* In preparation for the activity, ask TAs to start directing students to the activity instructions found in `16-Stu-Structured-Tests/README.md`.

### 9. Student Do: Implement and Write Structured Tests (15 min)

* Direct students to the activity instructions found in `16-Stu-Structured-Tests/README.md`.
