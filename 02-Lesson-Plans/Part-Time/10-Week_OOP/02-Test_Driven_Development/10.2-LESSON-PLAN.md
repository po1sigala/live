...
* Open `11-Ins-TDD/tests/arithmetic.test.js` in your IDE and demonstrate the following:
  ...
  * 🔑 Remember, the tests are prewritten and provided for us in this demo. In a typical TDD cycle, we would write these tests first.
...
* Run `npm install` from the command line and demonstrate the following: 
