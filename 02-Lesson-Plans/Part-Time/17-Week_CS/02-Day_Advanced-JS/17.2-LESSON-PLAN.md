...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 OOP is a programming paradigm that JavaScript uses. In OOP, we model our data around objects.
...
* Explain that we will be learning about the technical portion of the interview process, with a focus on the functional paradigm of JavaScript.
  ...
  * 🙋 The larger our app becomes, the more difficult it can be to restructure our class hierarchy.
