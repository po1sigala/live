...
Today's lesson diverges from the JavaScript-specific topics of the previous lessons and introduces students to algorithms that they are likely to encounter during a technical interview. This class covers search algorithms, recursion, and mock-interview practice with sorting algorithms.
...
* Break your students into pairs that will work together on this activity.
  ...
  * It's done when the search algorithm returns `-1` to indicate that the value is not in the set of data.
...
* Break your students into pairs that will work together on this activity.
  ...
  * As a developer, I want to be able to find the position of a value in a set of data using a binary search function.
  ...
  2. In the command line, run `npm run test` to run the unit tests.
