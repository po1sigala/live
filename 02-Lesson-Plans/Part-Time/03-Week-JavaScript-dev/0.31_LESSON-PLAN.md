...
* Stress that using the skills learned in class today, the students will be able to build an algorithm like the one demonstrated and build in decision-making into their own code. 
...
* Open `01-Ins_Script-ConsoleLog\index.html` in your IDE and note the following:
    ...
    * 🔑 To link an external Javascript file to HTML, inside the opening `<script>` a src attribute is added with the path to the external file.
...
* Use the prompts and talking points below to review the following key (🔑) points:
    ...
    * ✔️ The `console.log()` function logs message to console is a JavaScript function that logs a message to the console. The message is contained inside the `()`
