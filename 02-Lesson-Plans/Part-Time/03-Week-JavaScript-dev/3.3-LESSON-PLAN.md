...
* After giving the students an opportunity to respond, show them the following list of concepts to visually reinforce how much they have already learned: "Adding JavaScript to HTML files, console logs, variables, primitive types, logical operators, comparison operators, conditional statements, arrays, iteration, array methods, functions and scope."

* Congratulate the students on their progress and inform the students that they are now at an exciting part of their JavaScript journey. They are now ready to use HTML, CSS, and JavaScript to build interactive webpages on their own.  

* Remind the students that at the beginning of the week, we previewed an interactive Rock, Paper, Scissors game. 
...
* Note that the app is built on the same concepts as covered in class. Take a few minutes to point out a few of the core concepts covered in this week's class, including variables, arrays and conditional statements. 
