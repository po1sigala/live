...
In today's class, students will learn and objects and object methods. The git concept {TODO} will also be introduced. At the end of class, students will work in teams on the Rock, Paper, Scissors mini-project to reinforce and build on the JavaScript fundamentals covered this week. 
