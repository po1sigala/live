...
* 🔑 We can also use bracket notation to access a value. Don't forget when we use bracket notation, the key needs to go in quotes! 
...
* Open `23-Ins_Object-Methods/script.js` in your IDE and demonstrate the following:
  ...
  * 🔑 A method is a function associated with an object. To declare a method in an object, we assign the function a key.
  ...
  * 🔑 To call a method stored in an object, we use the object's name followed by the assigned key. Don't forget the `()`! 
