...
* The `this` keyword refers an object. The global object is the window. 

```js
console.log(this);
```

* When we use `this` inside of an object like `planet`, the keyword `this` refers to that object's properties.
