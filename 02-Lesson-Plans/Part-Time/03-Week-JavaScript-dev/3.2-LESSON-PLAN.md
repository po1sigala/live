...
* Open `19-Ins_Methods/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 Methods are not limited to arrays. Strings also have methods. The `replace` method will return a new string. In that new string, "String" is replaced with "World." 
