...
This class is a continuation of JavaScript fundamentals. Arrays, iteration, and array methods are introduced. Function expressions, function declarations and scope are also explored.  

## Instructor Notes

* Complete activities `11-Ins_Arrays` through `20-Stu_Methods`.

* Take a few minutes before class to review the activities of the day and think about questions students with a fundamental exposure to JavaScript may ask. 

* {TODO: Tip that says students are learning and building skills, point out the familiar in the code but nicely worded. 

* In `19-Stu_Scope`, students are asked to work with a partner to debug some broken code to learn more about scope and shadowing. This is a challenging activity especially for learners new to JavaScript. Please make sure to look through the solution code prior to class and think about the questions that may arise if need be review global scope (need link) and shadowing (need link) so you can confidently answer students questions. 
...
By the end of class, students will be able to: {TODO action words, fill this out}

* Identify and create an array that holds multiple values
