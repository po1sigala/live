...
* Open `19-Ins_Arrays/index.html` in your browser and demonstrate the following:
  ...
  * 🔑 Methods are not limited to arrays. Strings also have methods. 

  ```js
  
  ```

   * 🔑 These are just a few of the array and string methods available to use in our code. The best way to learn about array and string methods is to take some time to look at the documentation to see all the things that array and string methods can do. 
