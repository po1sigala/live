...
This class is a continuation of JavaScript fundamentals. Arrays, iteration, and array methods are introduced. In addition, function expressions, function declarations, and scope are explored.   
...
* Create an array and access the data using index

* Identify the difference between a function expression and a function declarion
