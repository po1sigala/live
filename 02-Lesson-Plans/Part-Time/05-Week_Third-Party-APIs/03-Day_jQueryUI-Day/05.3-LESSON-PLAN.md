...
| 11:15AM| 9   | Student Do: Day.js Format                 | 0:15     |
...
| 7:35PM | 8   | Instructor Demo: Day.js Format            | 0:05     |
| 7:40PM | 9   | Student Do: Day.js Format                 | 0:15     |
| 7:55PM | 10  | BREAK                                     | **0:15** |
| 8:10PM | 11  | Instructor Review: Day.js Format          | 0:10     |
...
* Open `28-Stu_Mini-Project/Solved/index.html` in your browser and demonstrate the following:
  ...
  * Datepicker is a jQuery UI widget, and Day.js calculates the days until the due date. We will learn more about both of these tools today!
...
* Open `25-Ins_DayJS-Format/assets/js/script.js` in your IDE and explain the following:
  ...
  * For the answer to the first question, we format the day object `today` to use `MM Do, YYYY` format:
  ...
  * For the third question, we parse the 11/3/2020 and reformat it into `dddd, MMMM Do YYYY, h:mm:ss a` format:
    ...
    ```js
    var reformatDate = dayjs("11/3/20").format("dddd, MMMM D YYYY, h:mm:ss a");
...
In this project, you will work with others to create a project tracker application using Bootstrap, jQuery, jQueryUI, Day, and Google Fonts. Break up these phases amongst members of your team.
