...
* Navigate to `11-Ins_Connect-Node` in your command line and enter `mysql -uroot -p` to enter MySQL Shell.
...
* Navigate to `15-Ins_Schema` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `16-Stu_Schema/Solved` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `17-Ins_Seeds` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `18-Stu_Seeds/Solved` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `20-Stu_Foreign-Primary-Key/Solved` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
