...
* Navigate to `21-Ins_Prepared-Statements/db` in your command line and enter `mysql -uroot -p` to start MySQL Shell and demonstrate the following:
...
* Navigate to `22-Stu_Prepared-Statements/Solved/db` in your command line and enter `mysql -uroot -p` to start MySQL Shell and demonstrate the following:
...
* Navigate to `23-Ins_COUNT-GROUPBY/db` in your command line and enter `mysql -uroot -p` to start MySQL Shell and demonstrate the following:
...
* Navigate to `24-Stu_COUNT-GROUPBY/Solved/db` in your command line and enter `mysql -uroot -p` to start MySQL Shell and demonstrate the following:
...
* Open `28-Stu_Mini-Project/Main/db` from the command line and run `mysql -uroot` to open MySQL Shell and explain the following:
...
* Open `12-SQL/02-Homework/Main/db` from the command line and run `mysql -uroot -p` to open MySQL Shell and demonstrate the following.
