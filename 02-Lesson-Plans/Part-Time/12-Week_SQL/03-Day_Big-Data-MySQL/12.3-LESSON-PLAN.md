...
* Navigate to `25-Ins_Join/` in the command line and demonstrate the following:
  ...
  * 🔑 We set up the database and tables by typing `source db/schema.sql` in the MySQL Shell.
  ...
  * 🔑 We join the `department` and `course names` data together by executing a query in `db/query.sql`.

* Navigate to `25-Ins_Join/db/schema.sql` in the command line and demonstrate the following:
