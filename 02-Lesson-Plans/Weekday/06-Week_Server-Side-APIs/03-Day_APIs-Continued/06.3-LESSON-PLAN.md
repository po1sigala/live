# 6.3 Lesson Plan - Real-World API Application Development (6:30 PM)
...
[06.3 Time Tracker](https://docs.google.com/spreadsheets/d/1rf4sCQ7lyZAg9LLEtHe7d3lVklgF4mCu3fmGvVF8kQo/edit?usp=sharing) to help keep track of time during class.
...
### 9. Partners Do: Pausing Gifs (10 min)
...
### 14. Students Do: NYT Example - Design and API (25 min)
...
* From time to time, offer the below helpful HINTs to students who may be stuck.
  ...
  * All of you should be using the [API Console](https://developer.nytimes.com/docs/articlesearch-product/1/overview#/Console/GET/articlesearch.json). The console allows you to create "test URLs". This way you can confirm that you are pinging the right URL.
...
### 15. Students Do: NYT Example - Coding the Logic (25 min)
