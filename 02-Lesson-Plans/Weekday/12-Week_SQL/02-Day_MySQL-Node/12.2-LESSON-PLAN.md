...
* Make sure that students can initialize the MySQL Shell prompt using the command `mysql -uroot -p`. They will need their MySQL password. Students should be encouraged to use a password that is not used for any other personal accounts.
...
| 8:55PM | 15  | Instructor Demo: Foreign and Primary Keys  | 0:05     |
| 9:00PM | 16  | Student Do: Foreign and Primary Keys       | 0:15     |
| 9:15PM | 17  | Instructor Review: Foreign and Primary Keys| 0:15     |
| 9:30PM | 18  | END                                        | 0:00     |
...
* Navigate to `11-Ins_Connect-Node/db` in your command line and enter `mysql -uroot -p` to enter MySQL Shell.
...
* Navigate to `15-Ins_Schema/db` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `16-Stu_Schema/Solved/db` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `17-Ins_Seeds/db` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `18-Stu_Seeds/Solved/db` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
...
* Navigate to `20-Stu_Foreign-Primary-Key/Solved/db` in your command line and input `mysql -uroot -p`, to enter MySQL Shell and demonstrate the following:
