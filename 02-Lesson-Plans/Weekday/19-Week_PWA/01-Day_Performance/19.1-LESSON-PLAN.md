# 19.1 Lesson Plan - Web Performance (6:30 PM)
...
[19.1 Time Tracker](https://docs.google.com/spreadsheets/d/1eDBMDxGxeXK44XfEzpSHYhD91buf2EVmiMQReykOd6g/edit?usp=sharing)
...
* Open the [Gallery App](https://lazyyload.herokuapp.com/) and run the application. Let students know this is an application they will be working with after break later today.
...
* Direct students to the activity instructions located in [02-Stu_Minifiy-JS](../../../../01-Class-Content/19-PWA/01-Activities/02-Stu_Minifify-JS/README.md)
...
* Navigate to [06-Stu_Gallery-Optimize/Solved](../../../../01-Class-Content/19-PWA/01-Activities06-Stu_Gallery-Optimize/Solved) and run the following commands:

  * npm install

  * npm install compression

* Navigate to the [06-Stu_Gallery-Optimize/Solved/server.js](../../../../01-Class-Content/19-PWA/01-Activities06-Stu_Gallery-Optimize/Solved/server.js)
