...
| 7:40PM | 8   | Instructor Demo: typeDefs and Resolvers   | 0:05     |
| 7:45PM | 9   | Student Do: typeDefs and Resolvers        | 0:15     |
| 8:00PM | 10  | BREAK                                     | 0:15     |
| 8:15PM | 11  | Instructor Review: typeDefs and Resolvers | 0:10     |
| 8:25PM | 12  | Instructor Demo: Arguments                | 0:05     |
| 8:30PM | 13  | Student Do: Arguments                     | 0:15     |
| 8:45PM | 14  | Instructor Review: Arguments              | 0:10     |
 ...
 * 🔑 To create a new instance of our Apollo Server, we wrap our functionality in an async function that takes the `typeDefs` and `resolvers` as parameters. Inside the function, we start our Apollo Server, use an instance of Express with `app.use()` and open our database to retrieve our data. 
...
* To start our Apollo Server, we call it at the bottom of our `server.js` file: 
...
=======
* Open `localhost:3001/graphql` in your browser and demonstrate the following:
>>>>>>> b0b48a1845f1cac15ce2a9d484dc05e8978cd3be
