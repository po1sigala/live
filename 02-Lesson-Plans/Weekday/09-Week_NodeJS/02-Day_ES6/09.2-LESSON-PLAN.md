...
* Open `18-Stu_Package-npm/init/README.md` in your IDE and explain the following: 
...
* Open `18-Stu_Package-npm/package/README.md` in your IDE and explain the following: 
