...
* Open `28-Stu_Mini-Project/Main/models/Trip.js` in your IDE and explain the following:
...
* Open `28-Stu_Mini-Project/Main/models/index.js` in your IDE and explain the following:
...
* Open `28-Stu_Mini-Project/Main/routes/api/travellerRoutes.js` in your IDE and explain the following:
...
* Open `28-Stu_Mini-Project/Main/config/connection.js` in your IDE and explain the following:
