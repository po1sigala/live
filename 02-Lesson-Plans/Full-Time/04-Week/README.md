...
=======
* Because some of the technologies we use in this course like GraphQL and MERN do not work well with Node v18, we will use Node v16. Once these problems have been resolved, using Node v18 will be fine. 

* MacOS use `brew install node@16` to lock into Node 16. 
...
>>>>>>> 102f84ecd95b9782d0e8cd94c0278de587e25192
