...
* In the next unit, students will start using Heroku. Advise them to sign up for a Heroku account and install the Heroku CLI before the next unit. Direct students to the [Heroku CLI installation guide on the Full-Stack Blog](https://coding-boot-camp.github.io/full-stack/heroku/how-to-install-the-heroku-cli) for extra guidance.
...
* Navigate to `02-Homework/Main` and run `node app.js` from the command line to demonstrate the following:
  ...
  * You can find a mockup of what that webpage should look like in the `02-Homework/Assets` directory. 
